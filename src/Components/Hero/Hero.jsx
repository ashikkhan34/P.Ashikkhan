...
export default function Hero() {
    const texts = ["MERN Stack Developer", "Front-end Developer", "Full-Stack Developer"];
            ...
            <div className="hero bg-gradient-to-r from-blue-950 via-black to-purple-900 min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div data-aos="fade-right"
                        data-aos-duration="3000">
                        <h1 className="text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500">Ashik khan</h1>
                        <h1 className='text-cyan-500 font-bold'>{displayText}</h1>
                        <h3 className='font-bold text-gray-400'>Junior Front-End Developer || Junior Mern Stack Developer || junior Full-Stack Developer</h3>
                        <p className="py-6">
                        ...
                        <button >
                            <a href={resume} target='_blank' class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-indigo-950 group">
