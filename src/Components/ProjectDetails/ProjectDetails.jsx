...
export default function ProjectDetails() {
  ...
  if (!project) {
    return (
      <h2 className="text-center text-red-500 text-3xl">Project Not Found!</h2>
    );
  }
  return (
    <div className="pt-16">
        ...
        <div className="bg-gradient-to-r from-blue-950 via-black to-purple-900 min-h-screen ">
          <div className=" p-6 md:flex  text-white">
            <img
              ...
              className=" w-full md:w-6/12 my-4 rounded"
              src={project.image}
              alt={project.name}
            />
            <div
            ...
            >
              ...
              >
                <button className="btn btn-dash btn-secondary">
                  <a href={project.github_clint} target="_blank">
                    Front-End Code
                  </a>
                </button>
