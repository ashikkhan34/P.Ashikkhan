...
export default function Navbar() {
  ...
  <NavLink to='/aboutUs'><li><a>About</a></li> </NavLink>
  ...
  return (
    <div>
      <div className="navbar bg-indigo-950 fixed top-0 w-full z-40 shadow-sm">
        ...
        <button >
                            <a href="#_" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-white transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-blue-600 group">
